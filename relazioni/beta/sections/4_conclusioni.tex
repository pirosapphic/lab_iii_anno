...
Si è poi considerato lo spettro del ${}^{137}$Cs, stimando sia la posizione e la risoluzione sperimentale del picco di conversione interna sia, tramite l'analisi dei picchi a bassi canali, la risoluzione attesa dalle caratteristiche dell'apparato sul picco di conversione interna; queste due stime risultano statisticamente compatibili. Si è infine stimato il valore massimo della distribuzione $T_{max,\text{Cs}}$, che non risulta compatibile con il valore atteso per una sottostima dell'errore.
