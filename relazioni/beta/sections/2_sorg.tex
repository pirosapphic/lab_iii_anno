...
Si vuole ora stimare la risoluzione attesa dalle caratteristiche dell'apparato sul picco di conversione interna; a tal fine si è acquisito uno spettro con zoom sui bassi canali. 

\begin{figure} [H]
    \centering
    \includegraphics[width=0.82\linewidth]{fig2/fit_picchi_zoom.png}
...
\begin{table}[H]
	...
	\textbf{N. picco} & \textbf{$\mathbf{\chi^2}$ fit} & \textbf{d.o.f.} &$\mathbf{(p_i\pm\sigma_{p,i})}$\textbf{[CHN]} & $\mathbf{\Delta_{pp}}$\textbf{[CHN]} \\ \hline
        1   & 8 & 8 & $1430\pm50$    & \textbf{X} \\ \hline
        2   & 4 & 5 & $1600\pm40$    & $170\pm60$ \\ \hline        
        3   & 11 & 6 & $1780\pm50$  & $170\pm70$ \\ \hline
        4   & 16 & 8 & $1950\pm60$   & $170\pm70$ \\ \hline
        5   & 13 & 9 & $2130\pm60$ & $180\pm80$ \\ \hline
        6   & 9 & 9 & $2300\pm 70$ & $170\pm90$ \\ \hline
        7   & 11 & 7 & $2480\pm60$ & $180\pm90$ \\ \hline
        8   & 6 & 7 & $2660\pm60$ & $170\pm90$ \\ \hline
        9   & 10 & 8 & $2830\pm70$ & $170\pm100$ \\ \hline
        10   & 5 & 7 & $3000\pm70$ & $170\pm100$ \\ \hline
    \end{tabular}
...
Dalla teoria è noto che l'andamento delle deviazioni standard dei picchi
$\sigma_{p,i}$ è
$$\sigma_{p,i} = \sqrt{\sigma^2_0+N\sigma^2_p} \approx\sqrt{N}\sigma_p$$
dove $N$ è il numero di celle del SiPM accese corrispondente all'i-esimo picco e
$\sigma_p$ è (circa) la deviazione standard del picco corrispondente a una sola cella
accesa:
si è dunque stimato il numero di celle accese corrispondente al primo picco fittato
(come $\frac{p_1}{\langle\Delta_{pp}\rangle}\approx8$) e si è associato ai picchi
successivi un numero crescente di celle accese.\\
Il grafico di $\sigma_{p,i}$ in funzione di $\sqrt{N}$ è riportato in figura
\ref{fig:sigma_cs}.
\begin{figure} [H]
    \centering
    \includegraphics[width=0.65\linewidth]{fig2/cs137_sigma.png}
    \caption{ \footnotesize Grafico dei dati $(\sqrt{N},\sigma_{p,i})$ con fit
    lineare $y=mx+q$ e parametri estratti $m = (26\pm3)$CHN, $q = (-33\pm10)$CHN,
    $\chi^2=12$ e d.o.f.$=6$.}
    \label{fig:sigma_cs}
\end{figure}
Si è effettuata una regressione lineare su tutti i dati tranne il primo e l'ultimo
che, per errori sistematici sconosciuti, non seguono l'andamento approssimativamente
lineare degli altri: la regressione va a buon fine, anche se il termine noto non
risulta compatibile con 0, come previsto dalla teoria.\\
Dal coefficiente angolare si stima il valore
$$\sigma_p = (26\pm3)\text{CHN}$$

Si utilizza ora questo parametro, caratteristico dello strumento, per stimare la
risoluzione attesa del picco di conversione interna: detto
$N_{ci}:=\frac{\langle\text{CHN}\rangle_{ci}}{\langle\Delta_{pp}\rangle}$ il numero
di celle accese per il picco di conversione interna, essa vale

$$R_{att}=\sqrt{ \left(\frac{1}{\sqrt{N_{ci}}}\right)^2 +
\left(\frac{1}{\sqrt{N_{ci}}}\frac{\sigma_p}{\langle\Delta_{pp}\rangle}\right)^2}=
0.10\pm0.03
$$
