...
void fitLED_V53(string input = "../../data_SiPM/LED/Vbias/A8_LED"){    
...
//--------------------------------------------------------------------------------
    ...
    //PICCO 1
    TF1* gaus1 = new TF1("gaus1","gaus",60,105);
    ...
    //PICCO 2
    TF1* gaus2 = new TF1("gaus2","gaus",130,190);
...
/*
    //PICCO 3
    TF1* gaus3 = new TF1("gaus3","gaus",210,275);
