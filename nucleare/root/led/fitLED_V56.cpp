...
void fitLED_V56(string input = "../../data_SiPM/LED/Vbias/A8_LED"){    
    //firstly, we draw and fit the histograms, then we calculate <deltapp>;
//--------------------------------------------------------------------------------
    //56V
    string V = "56";
    string path = input+V+"292-5.txt";
    TH1D* histo27 = histo_filler("histo27","Energy Spectrum, G=29dB, V_{bias}="+V+"V, LED 2.5",path);
    ...
    //PICCO 1
    TF1* gaus1 = new TF1("gaus1","gaus",270,340);
    ...
    //PICCO 2
    TF1* gaus2 = new TF1("gaus2","gaus",570,650);
    ...
    //PICCO 3
    TF1* gaus3 = new TF1("gaus3","gaus",870,970);
