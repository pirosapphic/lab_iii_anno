...
//--------------------------------------------------------------------------------
    ...
    //PICCO 1
    TF1* gaus1 = new TF1("gaus1","gaus",210,260);
    ...
    //PICCO 2
    TF1* gaus2 = new TF1("gaus2","gaus",430,500);
...
/*
    //PICCO 5
    TF1* gaus5 = new TF1("gaus5","gaus",1090,1205);
    ...
    std::cout << "--------------------------------------------------------------------------------------------------------" << std::endl;
    norm[5] = gaus4->GetParameter(0); 
    s_norm[5] = gaus4->GetParError(0);
    peak[5] = gaus4->GetParameter(1); 
    s_peak[5] = gaus4->GetParError(1);
    sigma[5] = gaus4->GetParameter(2); 
    s_sigma[5] = gaus4->GetParError(2);
*/
    ...
    double s_meanh = histo27->GetStdDev();
