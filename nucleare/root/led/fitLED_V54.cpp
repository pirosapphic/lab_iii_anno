...
void fitLED_V54(string input = "../../data_SiPM/LED/Vbias/A8_LED"){    
    //firstly, we draw and fit the histograms, then we calculate <deltapp>;
//--------------------------------------------------------------------------------
    //54V
    string V = "54";
    string path = input+V+"292-5.txt";
    TH1D* histo27 = histo_filler("histo27","Spettro Energetico, G=29dB, V_{bias}=54V, LED 2.5;ADC channels[CHN];Conteggi[#]",path);
    ...
    //PICCO 1
    TF1* gaus1 = new TF1("gaus1","gaus",130,190);
    ...
    //PICCO 2
    TF1* gaus2 = new TF1("gaus2","gaus",280,350);
    ...
    //PICCO 3
    TF1* gaus3 = new TF1("gaus3","gaus",430,510);
    ...
    //PICCO 4
    TF1* gaus4 = new TF1("gaus4","gaus",580,665);
