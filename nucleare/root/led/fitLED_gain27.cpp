...
void fitLED_gain27(string input = "../../data_SiPM/LED/gain/A8_LED55"){    
    //firstly, we draw and fit the histograms, then we calculate <deltapp>;
//--------------------------------------------------------------------------------
    //27 dB
    string gain = "27";
    string path = input+gain+"2-5.txt";
    TH1D* histo27 = histo_filler("histo27","Spettro Energetico, G=27dB, V_{bias}=55V, LED 2.5;ADC channels [CHN];Conteggi[#]",path);
    ...
    //PICCO 1
    TF1* gaus1 = new TF1("gaus1","gaus",165,210);
    ...
    //PICCO 2
    TF1* gaus2 = new TF1("gaus2","gaus",345,400);
    ...
    //PICCO 3
    TF1* gaus3 = new TF1("gaus3","gaus",530,585);
    ...
    //PICCO 4
    TF1* gaus4 = new TF1("gaus4","gaus",705,775);
