...
void gate300() {
    ...
    string path = "../../data_fc/calib_spettr/gate300.txt";
    ...
    //secondo picco
    fitres = h1->Fit("gaus","RS+","e1",313.,317.);
    std::cout<<"p-value "<<fitres->Prob()<<std::endl;
    cout<< "stima picco 2 (viene!) : " << fitres->Parameter(1) << " pm " <<  fitres->Parameter(2)*2.355 <<endl;
    //16-esimo
    fitres = h1->Fit("gaus","RS+","e1",1552.,1556.);
    std::cout<<"p-value "<<fitres->Prob()<<std::endl;
    cout<< "stima picco 16 (viene!) : " << fitres->Parameter(1) << " pm " <<  fitres->Parameter(2)*2.355 <<endl;
    //11-esimo
    fitres = h1->Fit("gaus","RS+","e1",1097.,1100.);
    std::cout<<"p-value "<<fitres->Prob()<<std::endl;
    cout<< "stima picco 11 (viene!) : " << fitres->Parameter(1) << " pm " <<  fitres->Parameter(2)*2.355 <<endl;
    //12-esimo
    fitres = h1->Fit("gaus","RS+","e1",1103.,1107.);
    std::cout<<"p-value "<<fitres->Prob()<<std::endl;
    cout<< "stima picco 12 (viene!) : " << fitres->Parameter(1) << " pm " <<  fitres->Parameter(2)*2.355 <<endl;
}
