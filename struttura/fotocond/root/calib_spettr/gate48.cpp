...
void gate48() {
    ...
    string path = "../../data_fc/calib_spettr/gate48.txt";
    ...
    //19-esimo picco
    fitres = h1->Fit("gaus","RS+","e1",1667.,1671.);
    std::cout<<"p-value "<<fitres->Prob()<<std::endl;
    cout<< "stima picco 19 (non viene!): " << fitres->Parameter(1) << " pm " <<  fitres->Parameter(2)*2.355 <<endl;
    //13-esimo
    fitres = h1->Fit("gaus","RS+","e1",1456.,1460.);
    std::cout<<"p-value "<<fitres->Prob()<<std::endl;
    cout<< "stima picco 13 (viene!): " << fitres->Parameter(1) << " pm " <<  fitres->Parameter(2)*2.355 <<endl;
