...
void gate10() {
    ...
    string path = "../../data_fc/calib_spettr/gate10.txt";
    ...
    //primo picco
    fitres = h1->Fit("gaus","RS+","e1",198.,202.);
    std::cout<<"p-value "<<fitres->Prob()<<std::endl;
    cout<< "stima picco 1 (non viene!): " << fitres->Parameter(1) << " pm " <<  fitres->Parameter(2)*2.355 <<endl;
