...
void gate40(){
    ...
    cout<< "stima picco 9 (viene!): " << fitres->Parameter(1) << " pm " <<  fitres->Parameter(2)*2.355 <<endl;
    //sesto picco
    fitres = h1->Fit("gaus","RS+","e1",498.,502.);
    std::cout<<"p-value "<<fitres->Prob()<<std::endl;
    cout<< "stima picco 6 (viene!!): " << fitres->Parameter(1) << " pm " <<  fitres->Parameter(2)*2.355 <<endl;
    //decimo picco
    fitres = h1->Fit("gaus","RS+","e1",1007.,1010.);
    std::cout<<"p-value "<<fitres->Prob()<<std::endl;
    cout<< "stima picco 10 (viene!!): " << fitres->Parameter(1) << " pm " <<  fitres->Parameter(2)*2.355 <<endl;
    //19-esimo picco
    fitres = h1->Fit("gaus","RS+","e1",1667.,1670.);
    std::cout<<"p-value "<<fitres->Prob()<<std::endl;
