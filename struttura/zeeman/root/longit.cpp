...
void longit(){
    std::vector<double> I = {0.,2.54,3.24,4.03,5.04,6.08,7.23,7.95,8.96};
    int n = I.size();
...
//I=0----------------------------------------------------------------------
    string path = "../data/longit/l0.txt";
...
//------------------------------FINE CALCOLO DELTE---------------------------------
    ...
    Delta.shrink_to_fit();
    s_Delta.shrink_to_fit();
    delta[0]=1.e-25; //to avoid dividing by 0
    ...
    double muB = f1->GetParameter(1)*hc/2/mu/t/2;
    double s_muB = f1->GetParError(1)*hc/2/mu/t/2;
